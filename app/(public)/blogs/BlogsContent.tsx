          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-center gap-2 mt-12">
              <button
                ...
                disabled={page === 1}
                className="flex items-center gap-1.5 px-4 py-2 bg-secondary text-muted-foreground rounded-lg hover:text-foreground disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
